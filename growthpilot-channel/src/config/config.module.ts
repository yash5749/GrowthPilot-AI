  ...
  imports: [
    NestConfigModule.forRoot({
      ...
      load: [() => ({
        ...
        SIM_DELIVERED_DELAY: parseInt(process.env.SIM_DELIVERED_DELAY || '1000', 10),
        SIM_FAILED_DELAY: parseInt(process.env.SIM_FAILED_DELAY || '1500', 10),
        SIM_OPENED_DELAY: parseInt(process.env.SIM_OPENED_DELAY || '1500', 10),
        SIM_READ_DELAY: parseInt(process.env.SIM_READ_DELAY || '500', 10),
        SIM_CLICKED_DELAY: parseInt(process.env.SIM_CLICKED_DELAY || '1000', 10),
        SIM_PURCHASED_DELAY: parseInt(process.env.SIM_PURCHASED_DELAY || '1500', 10),
